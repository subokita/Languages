...
# niçin / niye / neden
- they mean *why* and can be used interchangeably
- they can be answered by `çünkü` *because*
	- `A: Bana niye inanmıyorsun?`
	- *A: Why do you not believe me?*
	- `B: Çünkü artık sana güvenmiyorum`
	- *B: Because I don't trust you anymore*
- `neden` is in the same form as the ablative of `ne` (which is `neden`), it means *from what*
	- `Sen neden ağlıyorsun?`
	- *Why are you crying?*

# kaç
- it means *how many*
- in subject questions, it's used before singular nominative nouns with singular verb
	- `A: Suriye'de kaç sivil öldürüldü?`
	- *A: How many civilians were killed in Syria*
	- `B: Yüz binlerce`
	- *B: Hundred of thousands*
- in other questions, nouns (singular) may take case suffixes
	- `A: Günde kaç sigara içiyorsun?`
	- *A: How many cigarettes do you smoke a day?*
	- `B: Bir paketten fazla`
	- *B: More than a packet*
	- `A: Kendini öldürmeye mi çalısıyorsun?`
	- *A: Are you trying to kill yourself?*
...
# ne kadar
- it means *how much*
	- `A: Şişede ne kadar süt var?`
	- *A: How much milk is there in the bottle?*
	- `B: Çok az`
	- *B: Very little*
- it's also used to ask the price of something

# hangi
- it means *which*
- in subject question, it can be used before singular or plural nominative nouns, but always used with singular verb
	- `A: En İyi Film Oscar'ını hangi film kazandı?`
	- *A: Which film won an Oscar for Best Picture?*
	- `B: Ödül törenini seyretmedim`
	- *B: I didn't watch the award ceremony*
- in other questions, nouns take the case suffixes
	- `A: Hangi üniversiteden mezun oldunuz?`
	- *A: Which university have you graduated from?*
	- `B: Marmara Üniversitesi'nden`
	- *B: From Marmara University*